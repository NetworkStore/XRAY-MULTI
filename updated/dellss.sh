...
echo "Checking VPS"
IZIN=$( curl https://raw.githubusercontent.com/NetworkStore/perizinan/main/ipvps.txt | grep $MYIP )
if [ $MYIP = $MYIP ]; then
echo -e "${NC}${GREEN}Permission Accepted...${NC}"
else
echo -e "${NC}${RED}Permission Denied!${NC}";
echo -e "${NC}${LIGHT}Please Contact Admin!!"
echo -e "${NC}${LIGHT}Facebook : https://m.facebook.com/anonymous.user.indo"
echo -e "${NC}${LIGHT}WhatsApp : 081282840785"
echo -e "${NC}${LIGHT}Telegram : https://t.me/AndreSakti_Store"
exit 0
fi
clear
...
echo "Expired   : $exp"
echo "==========================="
echo "Script Mod By AndreSakti_Store"
